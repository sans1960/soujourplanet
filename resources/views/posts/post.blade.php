...
<div class="container flex flex-col w-3/5 mx-auto mt-5  border-b-4 border-b-gray-700 mb-5">
    ...
    <figure>
     ...
     <div class="p-3 text-gray-600 font-open-sans indent-8 tracking-wide">
         {!! $post->extract !!}
     </div>
     <div class="p-3 text-gray-600 font-open-sans indent-8 tracking-wide">
        {!! $post->body !!}
