...
<div class="container flex flex-col w-3/4 mx-auto mt-5 mb-5 border-b-4 border-b-gray-700">
    ...
    <div class="mx-auto mt-4 mb-5 flex justify-center items-center">
        <a class="text-sm md:text-base px-8 py-2 tracking-wider bg-white border-2 border-gray-900 cursor-pointer rounded-3xl hover:bg-gray-800 hover:text-white font-patua-one" href="{{ route('contact',[$post->slug,$post->subregion_id,$post->country_id]) }}">Start to plan my trip</a>
    </div>
