...
<div class="container flex flex-col items-start justify-between mx-auto lg:flex-row">
    <div class="flex flex-col w-full p-3 m-5 border-b-4 lg:w-3/4 border-b-gray-700">
        ...
        <div class="flex items-center justify-center mx-auto mt-4 mb-5">
            <a class="px-8 py-2 text-sm tracking-wider bg-white border-2 border-gray-900 cursor-pointer md:text-base rounded-3xl hover:bg-gray-800 hover:text-white font-patua-one" href="{{ route('contact',[$post->slug,$post->subregion_id,$post->country_id]) }}">Start to plan my trip</a>
        </div>
