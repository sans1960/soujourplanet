...
<div class="container mx-auto">
    <div class="w-1/2 p-4 mx-auto mt-5 ">
        ...
        <form action="{{ route('admin.destinations.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <input id="" type="text" class="w-full p-2 mt-5 border-2 border-blue-500 rounded-lg " name="name" value="" placeholder="Destination name" required  autofocus>
            ...
            <input type="file" name="head" id="image" class="border-2 border-blue-500 mt-5 p-2 w-full rounded-lg">
