...
<div class="container flex flex-row items-center justify-between p-4 mx-auto mt-5 border-b-4">
    <h1 class="text-2xl">All Subregions</h1>
    <a href="{{ route('admin.subregions.create') }}" class="px-6 py-2 text-white bg-gray-700 rounded-lg">
    ...
    <table class="block min-w-full border-collapse md:table">
        ...
        <tbody class="block md:table-row-group">
            @foreach ($subregions as $subregion)
                <tr>
                    <td class="block p-2 text-left md:border md:border-grey-500 md:table-cell">{{ $subregion->name }}</td>
