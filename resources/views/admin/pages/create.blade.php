...
<div class="container mx-auto">
    <div class="w-1/2 p-4 mx-auto mt-5 ">
        <h1 class="mt-5 text-xl text-center font-patua-one"> Create Page</h1>
        <form action="{{ route('admin.pages.store') }}" method="post" enctype="multipart/form-data">
            ...
            <input type="text" name="caption" id="" class="w-full p-2 mt-5 border-blue-500 rounded-lg " placeholder="Caption">
