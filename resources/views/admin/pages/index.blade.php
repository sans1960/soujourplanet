...
<div class="container flex flex-row items-center justify-between p-4 mx-auto mt-5 border-b-4">
    <h1 class="text-2xl">All Pages</h1>
    <a href="{{ route('admin.pages.create') }}" class="px-6 py-2 text-white bg-gray-700 rounded-lg">
    ...
    <table class="block min-w-full border-collapse md:table">
        <thead class="block md:table-header-group">
            <tr class="absolute block border border-grey-500 md:border-none md:table-row -top-full md:top-auto -left-full md:left-auto md:relative ">
                <th class="block p-2 font-bold text-left text-white bg-gray-600 md:border md:border-grey-500 md:table-cell">Page Title</th>
                <th class="block p-2 font-bold text-left text-white bg-gray-600 md:border md:border-grey-500 md:table-cell">Category</th></th>
        ...
        <tbody class="block md:table-row-group">
           ...
           <tr>
            <td class="block p-2 text-left md:border md:border-grey-500 md:table-cell">{{ $page->title }}</td>

            <td class="block p-2 text-left md:border md:border-grey-500 md:table-cell">{{  $page->category->name }}</td>
            <td class="block p-2 text-left md:border md:border-grey-500 md:table-cell">{{  $page->date}}</td>
            <td>
